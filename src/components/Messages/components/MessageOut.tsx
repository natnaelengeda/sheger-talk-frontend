...
export default function MessageOut({ id, message, time }: IMessageOut) {
  ...
  return (
    <div className='w-full h-auto flex items-end justify-end'>
      <div
        key={id}
        className='w-auto max-w-[90%] h-auto min-h-16 min-w-20 border border-gray-200 shadow-md bg-gray-50 text-black px-2 py-2 rounded-sm flex flex-col gap-1 self-end'>
        <div>
          <p
